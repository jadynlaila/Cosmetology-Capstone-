...
const sendPinEmail = async (req, res) => {
  ...
  try {
    ...
    const options = {
      ...
      text: client.pin
        ? `Hello ${client.name}! Your pin is ${client.pin}. Use this pin to sign in or to check clients in and out.`
        : `Something went wrong. Your pin returned undefined. Please contact jadyncalh@gmail.com to fix this error.`,
    };
